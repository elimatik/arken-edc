...
Last updated: 2026-06-13 | Session 35 COMPLETE — **CX-2501 & BR-2502 reorganized into 6 form groups each** (+13 new forms → CX 14 / BR 15), **explicit in-form sections**, and **pen-as-subject navigation** for livestock_group (clicking a pen opens the Subject Record directly, no nested table). NEXT: deferred form polish (SDV panel, sidebar deep-link, query re-open, conditional demographics).
