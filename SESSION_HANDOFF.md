...
Last updated: 2026-06-13 | Session 34 COMPLETE — **two new livestock studies** replace PH-2401/HF-3001: **CX-2501** (anticoccidial broiler trial, 4 arms, 8 pen forms) and **BR-2502** (bovine respiratory-disease trial, 8 animal forms) with **age-class heart-rate validation** (calf ≤6 mo 100–140 vs adult 48–84 bpm). CA-0801 kept. NEXT: deferred form polish (SDV panel, sidebar deep-link, query re-open, conditional demographics).
