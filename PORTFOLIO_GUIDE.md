...
- The dataset lives in **`sessionStorage`** (key **`arken_session_store_v24`** — bumped on any dataset-shape change) behind a React context — every screen reads it through **`useStudySession()`**, never calling Supabase directly.
