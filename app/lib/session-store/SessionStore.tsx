...
const DATA_KEY = "arken_session_store_v22"; // v22: BR-2502 final 8-group structure (Day 0 clinical response simpler) + Batch Entry rebuilt faithful to 20-batch-entry.html
