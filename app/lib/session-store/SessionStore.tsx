...
const DATA_KEY = "arken_session_store_v31"; // v31: PVAS fields paired with "Owner diary date" (pvas_diary_date) on CA-0801; v30: CA status form renamed → "Withdrawal Form"; v29: CADESI-04 canonical 3 subtotals + EOS subtotal demo; v28: CADESI breakdown, DART recommended-action + overall-eligibility calc fields, F4 test-article auto-populate, studyLocks
