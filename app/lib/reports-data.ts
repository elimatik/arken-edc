...
export const REPORT_CATALOG: ReportMeta[] = [
  ...
  { id: "sdv-completion", title: "SDV Completion Report", slug: "sdv_completion", category: "Safety & Regulatory", icon: "shield-check",
    ...
    roles: ["CRA", "DM", "Admin"], hasCsv: true },
  { id: "query-listing", title: "Query Listing", slug: "query_listing", category: "Data Quality & Integrity", icon: "list-details",
    description: "The full query worklist — every query with subject, field, status, age, and assignment, with filters and export.",
    roles: ["CRA", "DM", "PI", "Admin"], hasCsv: true },
