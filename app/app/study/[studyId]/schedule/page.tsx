...
function Marker({ type }: { type: MarkerType | LiveStatus }) {
  switch (type) {
    ...
    case "note": return <span className="marker marker-note" title="Conditional — see footnote">◆</span>;
  ...
  return (
    <div className="soe-screen">
      ...
      <div className="soe-legend">
        ...
        <span className="legend-item"><span className="marker marker-note">◆</span> Conditional</span>
